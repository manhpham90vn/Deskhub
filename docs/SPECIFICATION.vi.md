...
| H-18 | Passcode hiện rõ ngay trên màn hình | Khi đã bắt đầu share hoặc đang bắt đầu, màn hình host hiển thị passcode ghép đôi riêng một chỗ — các chữ số cách nhau, cỡ lớn, font monospace — kèm nút **Copy passcode** đặt mã thuần vào clipboard; trước đó chưa có mã nào đáng hiển thị nên khung này ẩn đi. Mã không còn được ghép vào câu trạng thái share nữa; câu đó chỉ còn phần giải thích. Khi không đặt passcode, khung ghi *None* và không có nút copy. Việc sửa passcode nằm ở trang **Settings**, cạnh các thiết lập bảo mật khác, trên mọi nền tảng. |
...
| C-7 | Tên viewer | Ô *Your name* trên trang connect đặt tên cho thiết bị này. Cho tới khi người dùng đặt tên lần đầu, ô này được điền sẵn giá trị mặc định theo nền tảng: hostname trên Windows và Linux (tên đăng nhập nếu không có hostname), tên máy trên macOS, tên thiết bị trên iOS, và model thiết bị trên Android. Ô này có thể chỉnh sửa, và giá trị tại thời điểm connect là giá trị được lưu và gửi đi. Giá trị này không bao giờ rỗng: connect với ô đã xoá trắng sẽ khôi phục giá trị mặc định theo nền tảng, giá trị đó được điền lại vào ô, được lưu và gửi đi, nên mỗi kết nối luôn kèm một tên. Host hiển thị tên này cạnh địa chỉ của máy để phân biệt các viewer. Tên được lưu trên chính thiết bị, chứa tối đa **64** byte văn bản, và các ký tự điều khiển bị loại bỏ. |
...
| S-4 | Khoá sau nhiều lần thất bại | **3** lần nhập sai passcode sẽ khoá cơ chế pairing của host trong **30 giây**, và máy đang thử được thông báo chờ. Mỗi lần khoá liên tiếp sau đó kéo dài gấp đôi lần trước, tối đa **1 giờ**; một passcode đúng đưa thời gian khoá về lại 30 giây. Các máy đã pair không bị ảnh hưởng. |
